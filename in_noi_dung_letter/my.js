...
let receiver= prompt("nhap nguoi nhan:");
let place= prompt("nhap dia diem:");
let time= prompt("nhap thoi gian:")
document.write("\""+receiver+" thương nhớ,"+"<br>");
...
document.write("Anh yêu thương, đừng bao giờ rời xa em nữa nhé. Yêu anh rất nhiều."+"<br>");
document.write(place+","+time+"\"") ;